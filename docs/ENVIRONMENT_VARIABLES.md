...
This document lists all environment variables used by OpenMemory MCP Server, organized by category.
...
| `OPENMEMORY_API_KEY` | API key for HTTP endpoints | `openssl rand -base64 32` |
...
OPENMEMORY_API_KEY=generated_secret
...
- **Rotate secrets periodically** (especially CRON_SECRET and OPENMEMORY_API_KEY)
