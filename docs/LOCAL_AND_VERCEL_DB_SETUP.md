...
# =============================================================================
DATABASE_URL=postgresql://$(whoami)@localhost:5432/unmute

# On macOS, usually no password needed. If you have a password:
# DATABASE_URL=postgresql://username:password@localhost:5432/unmute
...
```env
DATABASE_URL=postgresql://your_username@localhost:5432/unmute
```
...
- **Local**: `DATABASE_URL=postgresql://username@localhost:5432/unmute` in `.env`
