...
export async function startSession(scope: string[] = []): Promise<AgentSession> {
...
export async function getRecentSessions(limit = 5): Promise<AgentSession[]> {
...
export async function getLastSession(): Promise<AgentSession | null> {
