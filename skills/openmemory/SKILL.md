---
name: openmemory
description: Provides project context and session memory for AI agents via the OpenMemory MCP server. Use at the start of every conversation to get a briefing on active issues, recent decisions, and open items. Use during work sessions to record decisions and progress for the next agent.
---
...
1. Call `get_agent_briefing` from the openmemory MCP server
